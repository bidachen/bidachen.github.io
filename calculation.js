...
class Calculation extends React.Component {
  ...
  render() {
    ...
    let hint = this.state.correct
      ? "correct: " + this.state.sum
      : "incorrect :  " + this.state.sum;
    return (
      <div>
        <h1>
          What is {this.state.l} {operator} {this.state.r} ?
        </h1>
              ...
              <Button
                ...
                select={
                  this.state.operator === 3
                    ? (this.state.sum - listNum).toFixed(2)
                    : this.state.sum - listNum
                }
              />
            </div>
          ))}
